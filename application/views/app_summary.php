                    ...
                    <div class="row">
                        <div class="panel-body">
                            <div class="table-responsive">
                                   ...
                                   <table>
                                    ...
                                    <div id="container">
                                        <div class="cell">
                                            ...
                                            <span>Address:</span>
                                            <div align="buttom">Agency Account Code:</div>                                           
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="16" id="QR">Quantity Requirments</th>
                                    ...
                                    <?php 
                                    //$qry1=$this->db->where('vacs',$vacs)->where('separatr', 'A')->join('tbltransaction',"tbltransaction.item_id=tblitems.item_id")->get('tblitems') 
                                    $qry1 = $this->db->query("SELECT tblitems.description, tblitems.item_id, 
                                      ...
                                      SUM(tbltransaction.qty_jan,tbltransaction.qty_feb,tbltransaction.qty_mar) as fq, 
                                      ...
                                      WHERE tblitems.vacs = $vacs AND tblitems.separatr = 'A' 
                                    ...
                                    <?php foreach ($qry1->result() as $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 35px; font-weight: bold; text-align: center;"><?php echo $Q1 ?></td>
                                            ...
                                            <td style="width: 35px; font-weight: bold; text-align: center;"><?php echo $Q2 ?></td>
                                            ...
                                            <td style="width: 35px; font-weight: bold; text-align: center;"><?php echo $Q3 ?></td>
                                            ...
                                            <td style="width: 35px; font-weight: bold; text-align: center;"><?php echo $Q4 ?></td>
                                            <td id="catalogue" style="font-weight: bold;"><?php echo $row->price; ?></td>
                                            
                                            <td id="amount" style="font-weight: bold;"><?php echo number_format($row->total_price,2); ?></td>
                                        </tr>
                                     <?php } }?> 
                                   </tbody>
                                    </table>
                                    ...
                                    <table border="1" id="table_2">
                                      <tr>
                                        <th colspan="21" id="a">B. OTHER ITEMS NOT AVALABLE AT PS BUT REGULARLY PURCHASED FROM OTHER SOURCES (Note: Please indicate price of items)</th>
                                    </tr>
                                    </table>
                                    <table border="1" id="table_2" style="">                                    
                                    <tbody>
                                   ...
                                   <?php 
                                   //$qry2=$this->db->where('vacs',$vacs)->where('separatr','B')->join('tbltransaction',"tbltransaction.item_id=tblitems.item_id")->get('tblitems') 

                                   $qry2 = $this->db->query("SELECT tblitems.description, tblitems.item_id, 
                                      SUM(tbltransaction.qty_jan) as qty_jan, 
                                      SUM(tbltransaction.qty_feb) as qty_feb, 
                                      SUM(tbltransaction.qty_mar) as qty_mar, 
                                      SUM(tbltransaction.qty_apr) as qty_apr, 
                                      ...
                                      FROM tbltransaction 
                                      INNER JOIN `tblitems` ON `tblitems`.item_id = tbltransaction.item_id 
                                      WHERE tblitems.vacs = $vacs AND tblitems.separatr = 'B' 
                                      GROUP BY tbltransaction.item_id");
                                   ?> 
                                    ...
                                    <table border="1" id="table_2">
                                      <tbody>
                                      <?php $qry3=$this->db->select_sum('total_price')->where('separatr','A')->join('tblitems',"tblitems.item_id=tbltransaction.item_id")->get('tbltransaction') ?> 
                                      <?php $qry4=$this->db->select_sum('total_price')->where('separatr','B')->join('tblitems',"tblitems.item_id=tbltransaction.item_id")->get('tbltransaction') ?>

                                      <?php  foreach ($qry3->result() as $row) { $additional=($row->total_price*0.10); ?>
                                      <?php  foreach ($qry4->result() as $value) { $ab=($row->total_price+$value->total_price);} ?>
                                        <tr>
                                      ...
                                      <th></th>
                                      <th id="catalogue"></th>
                                      <th id="amount"><?php echo number_format($ab,2); ?></th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th></th>
                                      <th id="catalogue"></th>
                                      <th id="amount"><?php echo number_format($additional,2); ?></th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th></th>
                                      <th id="catalogue"></th>
                                      <th id="amount"><?php echo number_format($row->total_price+$additional,2); ?></th>
                                    </tr>
                                    <tr>
                                    ...
                                    <h5 style="margin-left: 25px;">Prepared By:</h5>
                                    </br>
                                    </br>
                                    <h5 style="margin-left: 30px;">_____________________________________</h5>
                                    <h5 style="margin-left: 75px;">Property/Supply Officer</h5>

                                    <h5 style="margin-left: 425px; margin-top: -130px;">Certified Funds Available/</br>Certified Appropriate Funds Available: </h5>
                                    </br>
                                    </br>
                                    <h5 style="margin-left: 430px; margin-top: 0px;">_____________________________________</h5>
                                    <h5 style="margin-left: 455px; margin-top: 0px;">Accountant / Local Budget Officer</h5>

                                    <h5 style=" margin-right: 250px; text-align: right;">Approved by: </h5>
                                    </br>
                                    </br>
                                    </br>
                                    <h5 style=" margin-right: 250px; text-align: right;">_____________________________________</h5>
                                    <h5 style=" margin-right: 250px; text-align: right;"> Head of Office/Agency</h5>
